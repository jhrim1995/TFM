...
<div class="container my-5">
	<h2 class="text-center mb-4 fw-bold py-3 rounded shadow-sm custom-title">문의 사항</h2>
		<form name="checkForm" id="checkForm">
			<input type="hidden" name="no" value="${inquiry.no }" id="inquiry_no">
			<input type="hidden" name="pass" id="inquiryPass">
		...
		<div class="row my-3">
			<div class="col text-center">
				...
				<c:if test="${not searchOption }">
					<input type="button" class="btn btn-warning" value="목록보기" onclick="location.href='inquirylist.mvc?pageNum=${pageNum }'">
				</c:if>
			</div>
		</div>

						...
						<table class="table table-hover">
							...
							<c:forEach var="board" items="${ bList }">
								<tr>
									...
									<td class="text-secondary">
										<a href="boardDetail.mvc?no=${board.no}&pageNum=${currentPage}&type=${type}&keyword=${keyword}" 
							...
							<c:forEach var="board" items="${ bList }">
								<tr>
									<td>${board.no}</td> 
									<td class="text-secondary">
										<a href="boardDetail.mvc?no=${board.no}&pageNum=${currentPage}" 
										class="text-secondary text-decoration-none">${board.title}</a>
										</td>
									<td class="text-secondary">${board.writer}</td>
									<td>${board.regDate}</td>
					...
					<div class="col">
						<nav aria-label="Page navigation example">
						  <ul class="pagination justify-content-center">
						    ...
						    <li class="page-item">
						    	<a class="page-link" 
						    		href="boardList.mvc?pageNum=${startPage - pageGroup}&type=${type}&keyword=${keyword}">Pre</a>
						    </li>
						    </c:if>
						    ...
						    <li class="page-item">
						    	<a class="page-link" 
						    		href="boardList.mvc?pageNum=${startPage + pageGroup}&type=${type}&keyword=${keyword}">Next</a>
						    </li>
						    </c:if>
						  </ul>
						</nav>
